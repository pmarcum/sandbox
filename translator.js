...
// Load up astronomy journal names
  journalNames('astroJournals', '1', 'journals');
  


// COME BACK HERE 
// the misspelled words still needs work in order to be compiant with new format for these files!!!
...
// Load up words that should be substituted for other words:
  readInFile('substitutes', '2', 'substitute');
...
// words and phrases would automatically be included in the search if the "extended search mode" was activated.
    var clipHere = 0;
    var lines = (GM_getResourceText("commonSpecLines").trim()).split('\n');
